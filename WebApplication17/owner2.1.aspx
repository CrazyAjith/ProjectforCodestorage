<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="owner2.1.aspx.cs" Inherits="WebApplication17.owner2__1" %>
...
<center>           <h1><strong>CODES</strong></h1>
    <br />
             <div class="clearfix"> 
                 <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" PageSize="2">
                 ...
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ownersConnectionString2 %>" SelectCommand="SELECT * FROM [searching]"></asp:SqlDataSource>
