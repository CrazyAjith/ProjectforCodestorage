<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin5.aspx.cs" Inherits="WebApplication17.admin5" %>
...
<head runat="server">
      ...
      <title>Merged a Corporate Category Bootstrap Responsive Website Template  | Home :: w3layouts</title>
      <!-- Meta Tags -->
...
<!-- //Testimonials-slider-css-files -->
      ...
      <!--booststrap-->
      <link href="admin1/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="all">
      <!--//booststrap end-->
      <!-- font-awesome icons -->
      <link href="admin1/css/fontawesome-all.css" rel="stylesheet">
      <!-- //font-awesome icons -->
      <!--stylesheets-->
	  <link rel="stylesheet" href="admin1/css/flexslider.css" type="text/css" media="screen" />
	<!--stylesheets-->
		<link href="admin1/css/contact.css" rel="stylesheet" type='text/css' media="all" />
      <link href="admin1/css/style.css" rel='stylesheet' type='text/css' media="all">
      <!--//stylesheets-->
      <link href="admin1///fonts.googleapis.com/css?family=Lato:100,300,400,700,900" rel="stylesheet">
	  <link href="admin1///fonts.googleapis.com/css?family=Roboto+Condensed:400,700" rel="stylesheet">
    ...
    <div class="header-bar">
		<div class="container">
            <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
			   ...
			   <div class="hedder-up">
				  <h1><a class="navbar-brand" href="index.html">C<span>ode</span></a></h1>
			   </div>
                 <div class="hedder-up">
				  <h1><a class="navbar-brand" href="index.html">S<span>torage</span></a></h1>
			   </div>
	 ...
	 <ul class="navbar-nav">
                     ...
                     <li class="nav-item">
                        <a href="admin2.aspx" class="nav-link">Files<span class="sr-only">(current)</span></a>
                     </li>
                     <li class="nav-item">
                        <a href="admin4.aspx" class="nav-link">Notification</a>
                     </li>
         <li class="nav-item">
...
<div class="banner">
	<div class="agile_dot_info one">
		<div class="container">
						...
						<section class="slider">
							<div class="flexslider">
								<ul class="slides">
                                   ...
                                   <center><h1>Approved Files</h1></center> 
                        <br />
                        <br />                     
                         <div>
                             <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" AutoGenerateColumns="False"  >
                                 ...
                                 <Columns>
                                     <asp:TemplateField HeaderText="Plat_form">
                                         <ItemTemplate>
                                             <asp:Label ID="Label1" runat="server" Text='<%#Eval("Plat_form") %>'></asp:Label>
                                         </ItemTemplate>
                                     </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Concepts">
                                         <ItemTemplate>
                                             <asp:Label ID="Label2" runat="server" Text='<%#Eval("Concepts") %>'></asp:Label>
                                         </ItemTemplate>
                                     </asp:TemplateField>
          ...
          <ItemTemplate>
              <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Approve">Approve</asp:LinkButton>
          </ItemTemplate>
      </asp:TemplateField>
       
                                        <asp:TemplateField  HeaderText ="Action">
          <ItemTemplate>
              <asp:LinkButton ID="LinkButton2" runat="server"  CommandName=" Ignore">Ignore</asp:LinkButton>
          </ItemTemplate>
      </asp:TemplateField>
...
<section class="what_you">
	<div class="container">
		<div class="wthree_head_section">
				<h3 class="w3l_header">What you get</h3>
