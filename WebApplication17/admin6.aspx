<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin6.aspx.cs" EnableEventValidation="false" Inherits="WebApplication17.admin6" %>
			...
			<div class="w3_banner_info">
				<div class="container">
					<div class="flexslider-info">
                        ...
                        <div>
                            <asp:Button ID="Button1" runat="server" Text="Owner" BackColor="#CCCCCC" Height="38px" Width="162px" OnClick="Button1_Click" /><br /><br />
                            <asp:Button ID="Button2" runat="server" Text="Consumer" BackColor="#CCCCCC" Height="35px" Width="160px" OnClick="Button2_Click" />
                        </div>
					</div>
				</div>
