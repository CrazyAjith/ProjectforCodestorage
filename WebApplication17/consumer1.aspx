<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consumer1.aspx.cs" Inherits="WebApplication17.consumer1" %>
...
<body>
    ...
    <div>
				...
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false">
					...
					<div id="navbar" class="navbar-collapse navbar-right collapse hover-effect">
						...
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="consumer1.aspx" class="scroll">Search</a></li>
							<li><a href="consumer3.aspx" class="scroll">Files</a></li>
		...
		<div class="banner">
            <br />
			<center> <asp:TextBox ID="TextBox1" placeholder="search your code" runat="server" Width="266px"></asp:TextBox>
    ...
    <asp:TemplateField HeaderText ="Code ID">
      <ItemTemplate >
          <asp:Label ID="Label31" runat="server" Text='<%#Eval("CodeId") %>'></asp:Label>
      
      </ItemTemplate>
    </asp:TemplateField>
      <asp:TemplateField HeaderText ="Title">
      <ItemTemplate >
          <asp:Label ID="Label32" runat="server" Text='<%#Eval("Tittle") %>'></asp:Label>
      
      </ItemTemplate>
    </asp:TemplateField>
      <asp:TemplateField HeaderText ="Description">
      <ItemTemplate >
          <asp:Label ID="Label33" runat="server" Text='<%#Eval("Descriptions") %>'></asp:Label>
      
      </ItemTemplate>
    </asp:TemplateField>
      <asp:TemplateField HeaderText ="Syntax">
      <ItemTemplate >
          <asp:Label ID="Label34" runat="server" Text='<%#Eval("Syntax") %>'></asp:Label>
