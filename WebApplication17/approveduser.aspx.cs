...
namespace WebApplication17
{
    public partial class approveduser : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select*from reg1", con);
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Approve")
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("update reg1 set status='Approved' where Username='" + usernmae.Text + "' and Password='" + Password.Text + "'", con);
                cmd.ExecuteNonQuery();
            ...
            else
            {
                ...
                Label Password = (Label)gvrow.FindControl("Label2");
                con.Open();
                SqlCommand cmd = new SqlCommand("update reg1 set status='Declined' where Username='" + usernmae.Text + "' and Password='" + Password.Text + "'", con);
                cmd.ExecuteNonQuery();
