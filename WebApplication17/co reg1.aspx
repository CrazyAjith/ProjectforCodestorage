<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="co reg1.aspx.cs" Inherits="WebApplication17.co_reg1" %>
...
<!-- Custom Theme files -->
<link href="co reg1/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- //Custom Theme files -->
<!-- web font --> 
<link href="co reg1///fonts.googleapis.com/css?family=Poiret+One&amp;subset=cyrillic,latin-ext" rel="stylesheet">
<link href="co reg1///fonts.googleapis.com/css?family=Josefin+Sans:100,100i,300,300i,400,400i,600,600i,700,700i&amp;subset=latin-ext" rel="stylesheet">
<!-- //web font -->
</head>
<body>
	...
	<div class="main-w3layouts center-container">
		...
		<div class="main-agileinfo">
			<div class="agileits-top"> 
                ...
                <asp:TextBox ID="TextBox4" placeholder="Conform Password" runat="server"></asp:TextBox>
