<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminhome.aspx.cs" Inherits="WebApplication17.adminhome" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="admin/css/style.css" type="text/css" media="all" />
	  <link rel="stylesheet" href="admin/css/slider.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <!-- font-awesome-icons -->
    <link href="admin/css/font-awesome.css" rel="stylesheet">
    <!-- //font-awesome-icons -->
    <!-- /Fonts -->
   <link href="admin///fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
  <link href="admin///fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i" rel="stylesheet">
...
<header>
	<div class="container">
		...
		<nav class="py-3 d-lg-flex">
			<div id="logo">
				<h1> <a href="index.html"><span class="fa fa-rocket"></span> Admin</a></h1>
			</div>
			<label for="drop" class="toggle"><span class="fa fa-bars"></span></label>
			<input type="checkbox" id="drop" />
			<ul class="menu ml-auto mt-1">
				<li class="active"><a href="admin1.aspx">Home</a></li>
                <li class="active"><a href="admin2.aspx">Files</a></li>
<li class="active"><a href="admin2.aspx">Notification</a></li>
<li class="active"><a href="home.aspx">Logout</a></li>
			</ul>
		</nav>
		<!-- //nav -->
	</div>
