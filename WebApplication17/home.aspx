...
<head runat="server">
    <title>Demand Corporate Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- for-mobile-apps -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!-- css files -->
    <link href="home/css/css_slider.css" rel="stylesheet"><!-- Slider css -->
    <link href="home/css/bootstrap.css" rel='stylesheet' type='text/css' /><!-- bootstrap css -->
    <link href="home/css/style.css" rel='stylesheet' type='text/css' /><!-- custom css -->
    <link href="home/css/font-awesome.min.css" rel="stylesheet"><!-- fontawesome css -->
	<!-- //css files -->
	
	<!-- google fonts -->
	<link href="home///fonts.googleapis.com/css?family=Catamaran:100,200,300,400,500,600,700,800,900" rel="stylesheet">
	<link href="home///fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i&amp;subset=cyrillic,cyrillic-ext,greek,greek-ext,latin-ext,vietnamese" rel="stylesheet">
	<!-- //google fonts -->
...
<header>
	<div class="container">
		...
		<nav class="py-3 d-lg-flex">
			<div id="logo">
				<h3> <a href="index.html"><span class="fa fa-line-chart"></span> Code Storage Application </a></h3>
			</div>
		...
		<li class="active"><a href="buttons.aspx">Login</a></li>
					...
					<ul class="banner_slide_bg">
						<li>
							<div class="w3ls_banner_txt">
								<h2 class="b-w3ltxt text-capitalize mt-md-4">Code <span>Storage</span> </h2>
								<h4 class="b-w3ltxt text-capitalize">Best Application</h4>
						...
						<li>
							<div class="w3ls_banner_txt">
								<h3 class="b-w3ltxt text-capitalize mt-md-4">New <span>Launched</span> </h3>
								<h4 class="b-w3ltxt text-capitalize">Best Application</h4>
								</div>
						</li>
...
<section class="products py-5">
	<div class="container py-lg-5 py-3">
		<h3 class="heading mb-md-5 mb-4">Our Marketing <strong>Product</strong></h3>
