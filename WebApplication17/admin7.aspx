<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin7.aspx.cs" Inherits="WebApplication17.admin7" %>
...
<header>
    ...
    <div class="header-bar">
	 ...
	 <ul class="navbar-nav">
                     ...
                     <li class="nav-item">
                        <a href="admin2.aspx" class="nav-link">Files</a>
                     </li>
                     <li class="nav-item">
                        <a href="admin4.aspx" class="nav-link">Notification<span class="sr-only">(current)</span></a>
                     </li>
         <li class="nav-item">
						...
						<section class="slider">
							<div class="flexslider">
                                ...
                                <div>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" OnRowCommand="GridView1_RowCommand"  AutoGenerateColumns="False" >
                                     ...
                                     <asp:TemplateField HeaderText="CodeId">
                                         <ItemTemplate>
                                     ...
                                     <asp:BoundField DataField="Syntax" HeaderText="Syntax" SortExpression="Syntax" />
