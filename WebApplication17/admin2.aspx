<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin2.aspx.cs" Inherits="WebApplication17.filesbutton" %>
	...
	<div class="agile_dot_info one">
		<div class="container">
			<div class="w3_banner_info">
                ...
                <div>  <asp:Button ID="Button1" runat="server" Text="Approve Files" BackColor="#CCCCCC" Width="222px" Height="59px" OnClick="Button1_Click" />
                 </div>
			    <br />
                <div> <asp:Button ID="Button3" runat="server" Text="View Files" BackColor="#CCCCCC" Width="228px" Height="55px" OnClick="Button3_Click" />
			</div>
