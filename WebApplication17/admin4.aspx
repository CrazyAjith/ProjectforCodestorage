<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin4.aspx.cs" Inherits="WebApplication17.admin4" %>
		...
		<div class="container">
			<div class="w3_banner_info">
				<div class="container">
                    ...
                    <asp:Button ID="Button2" runat="server" Text="  Approved owner" BackColor="#CCCCCC" Height="50px" OnClick="Button2_Click" Width="303px" />
				      </div><br />
                <div>  <asp:Button ID="Button1" runat="server" Text="Approved Users" BackColor="#CCCCCC" Width="307px" Height="52px" OnClick="Button1_Click" />
                 </div>
			    <br />
                <div> <asp:Button ID="Button3" runat="server" Text="View Owner And Consumer" BackColor="#CCCCCC" Width="311px" Height="55px" OnClick="Button3_Click" />
			</div>
