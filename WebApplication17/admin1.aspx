<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin1.aspx.cs" Inherits="WebApplication17.admin1" %>
...
<div class="banner">
	<div class="agile_dot_info one">
		<div class="container">
			<div class="w3_banner_info" style="font-size: 33px">
				<div class="container">
                ...
                <span class="auto-style1">Total</span> <span class="auto-style2">Files</span>:  <asp:Label ID="Label1" runat="server" Text="Label" OnDataBinding="Label1_DataBinding" style="font-weight: 700; color: #FFFFFF"></asp:Label>
			    <br />
                <span class="auto-style2">Total</span> <span class="auto-style2">Users</span>:   <asp:Label ID="Label2" runat="server" Text="Label" style="font-weight: 700; color: #FFFFFF"></asp:Label>
                <div>
                    <br />
			</div>
